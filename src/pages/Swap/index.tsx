...
const Swap = () => {
  ...
  console.log("currencies[Field.INPUT] && currencies[Field.OUTPUT]",currencies[Field.INPUT] , currencies[Field.OUTPUT])
  console.log("parsedAmounts[independentField]?.greaterThan(JSBI.BigInt(0))",parsedAmounts[independentField]?.greaterThan(JSBI.BigInt(0)))
  console.log("independentField",independentField)
  console.log("parsedAmounts",parsedAmounts)
  console.log("parsedAmounts[independentField]",parsedAmounts[independentField])
